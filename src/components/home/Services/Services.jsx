...
export default function Services() {
    return (
        <div className="services partial-width">
            ...
            <Service s icon="turn_right" title="Avoir l’itinéraire complet" content="TransFy vous fournit l'itinéraire complet de votre voyage, du point de départ jusqu'au point d'arrivée. " />
